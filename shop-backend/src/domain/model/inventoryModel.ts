...
const InventorySchema = new Schema<IInventory>(
  {
    ...baseFields,
    shop: { type: Schema.Types.ObjectId, ref: COLLECTIONS.SHOP, required: true, index: true },
    item: { type: Schema.Types.ObjectId, ref: COLLECTIONS.ITEM, required: true, index: true },
...
export const Inventory = mongoose.model<IInventory>(COLLECTIONS.INVENTORY, InventorySchema);
