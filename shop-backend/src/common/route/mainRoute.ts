...
import { RequestHelper } from '@thinkcove-lib/base';
...
export interface RouteBuilderOptions {
   ...
   * }
   */
  businessLogic: (helper: RequestHelper) => Promise<any>;
...
export const routeBuilder = (
  options: RouteBuilderOptions | RouteBuilderOptions[],
): ServerRoute[] => {
  const buildRoute = (opt: RouteBuilderOptions): ServerRoute => {
